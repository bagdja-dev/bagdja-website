/**
 * Ikon lokal untuk template Store Classic — sengaja diduplikasi (bukan
 * import dari barber-classic-icons.tsx) supaya folder template ini mandiri
 * dan tidak punya dependency silang antar-template.
 */
